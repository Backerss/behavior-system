...
🏫 **ระบบสารสนเทศจัดการคะแนนวินัยนักเรียน** เป็นระบบที่พัฒนาขึ้นเพื่อช่วยในการจัดการและติดตามพฤติกรรมของนักเรียนในโรงเรียนนวมินทราชูทิศ มัชฌิม พร้อมด้วยระบบจัดการปีการศึกษาอัตโนมัติและการนำเข้าข้อมูลผ่านไฟล์ Excel / CSV ภายในระบบ
...
- 📥 **นำเข้าข้อมูลผ่านไฟล์ Excel / CSV** อย่างมีประสิทธิภาพ
...
- 📥 นำเข้าข้อมูลผ่านไฟล์ Excel / CSV (นักเรียน, ครู, ผู้ปกครอง)
...
- **รองรับหลายชีต (Sheet Tab)** จากไฟล์ Excel ที่อัปโหลด
- **แสดงตัวอย่าง + วิเคราะห์อัตโนมัติ** ทันทีหลังอัปโหลด
- **จัดหมวดหมู่ข้อมูล**: ทั้งหมด / ซ้ำ / ผิดพลาด / พร้อมนำเข้า
- **ตรวจสอบข้อมูลซ้ำ** (อีเมล, รหัสนักเรียน ฯลฯ) แบบ Real-time
- **เลือกแถวเฉพาะ** หรือ **นำเข้าทั้งชุดที่ถูกต้อง**
- **แจ้งเตือนแบบ Toast** แทน Alert เดิม เพื่อ UX ที่ลื่นไหล
- **รีเซ็ตสถานะอัตโนมัติ** เมื่อปิด Modal
...
### 🔗 การเชื่อมต่อภายนอก
- ![Excel](https://img.shields.io/badge/Excel-Import-217346?style=flat-square&logo=microsoft-excel&logoColor=white) **Excel / CSV Local Import** - นำเข้าข้อมูล
...
- 🎯 **ระบบนำเข้า Excel / CSV** - อัปโหลดผ่าน Modal ใน Dashboard (ไฟล์ .xlsx หรือ .csv)
